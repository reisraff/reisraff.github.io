...
```raw
 ...
 80493d2: e8 e9 fc ff ff        call   80490c0 <printf@plt>     aqui vamos mudar o EIP de 0x80493d2 para 0x80490c0
...
&& param_1 - (uint)DAT_0804c035 == (uint)DAT_0804c036) # deve resolver verdadeiro ou seja:
