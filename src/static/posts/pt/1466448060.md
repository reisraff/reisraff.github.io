...
![work-tools](../../static/post-assets/php.jpg =50%x* "PHP")
...
![work-tools](../../static/post-assets/task.jpg =50%x* "Task")
...
![work-tools](../../static/post-assets/phulpfile-src.png =100%x* "PhulpFile")
